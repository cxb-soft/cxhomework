...
<body class="mdui-theme-layout-dark">
    ...
    foreach($homework_list as $homework_item){
        ...
        if($state == "false"){
            ...
            <a mdui-tooltip=\"{content: '查看详情'}\" href='javascript:check_homework(\"$test_id\");'><li class=\"mdui-list-item mdui-ripple\">
    ...
    <script>
        ...
        function check_homework(test_id){
            window.location = "/users/user/states.php?test_id=" + test_id
        }
        function unlogin(){
            $.ajax({
             type: "POST",
